...
> - If some shaders work but not others, please [create a new issue][new-issue] or post to `#questions-and-help` in the [MagicaVoxel Community Discord][discord-invite].
